			...
			if(data.length != 0){
				for(var i in data){
					...
					var userRow = '<tr>'
								...
								+'<td><a class="edit btn btn-info   btn-xs" title="show contacts of '+data[i].name+'" target="_blank" href="admin/view?user_id='+data[i].id+'&name='+data[i].name+'"><i class="fa fa-eye"></i> view contacts</button></td>'
								+'</tr>';
